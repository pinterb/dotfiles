...
" BP set tabstop=2                   " Make tabs as wide as two spaces
" BP set cursorline                  " Highlight current line
...
"    colorscheme pacific 
    highlight SignColumn guibg=#272822
    highlight VertSplit ctermbg=darkblue ctermfg=grey
...
" Yaml settings
au BufNewFile,BufRead *.yml setlocal expandtab autoindent shiftwidth=2 softtabstop=2
au BufNewFile,BufRead *.yaml setlocal expandtab autoindent shiftwidth=2 softtabstop=2

" Ruby settings
au BufNewFile,BufRead *.rb setlocal expandtab autoindent shiftwidth=2 softtabstop=2
